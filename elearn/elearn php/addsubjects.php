<?php 
	...
	/*if(isset($postdata) && !empty($postdata))
	{
		...
		//add to user table
		$sql1 = "INSERT INTO user( uType,uID,uPassword ) VALUES( '{$user}','{$pNIC}','{$password}' )"; 
		...
		//$english = mysqli_real_escape_string($con, trim($request -> english));
	//}
